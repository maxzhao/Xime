...
- [`voice-input-host-compatibility/spec.md`](voice-input-host-compatibility/spec.md): normative contract for `TYPE_NULL` floating voice preview, raw-only pause/explicit-stop commits, deduplication and terminal-safe text preservation.
