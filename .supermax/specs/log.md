...
| 2026-09-19 | Added draft `voice-input-host-compatibility` specification linked to TaskAdmin `master/4`. | Defined capability-based `TYPE_NULL` handling, UI-only partials, one-shot raw commits, command-text preservation, and required Termux/manual validation; implementation and validation not run. |
